...
### Summary
- By combining these tools and services, organizations can build a scalable and efficient decision support system that can process large amounts of data in real-time, perform complex analytics and trigger workflows and decision-making processes.

<br>
All tools and services explained above can be used in conjunction to build a scalable and efficient decision support system, to respond quickly and make better informed decisions
